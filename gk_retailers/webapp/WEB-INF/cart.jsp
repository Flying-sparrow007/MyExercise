                	...
                	<div class="imfor">
	                    <div class="check">
	                        <div class="Each">
	                            ...
	                            <input type="hidden" id="cartId" name="id" value="${cart.id}">
	                        </div>
	                    </div>
	                    <div class="pudc">
	                        <div class="pudc_information" id="${cart.id}">
	                            <img src="${basePath}${cart.goodsImage}" class="lf" style="width: 100px;"/>
	                    ...
	                    <div class="totle">
	                        <span>￥</span>
	                        <span class="totle_information">${cart.goodsPrice}.00</span>
	                    </div>
	                    <div class="del">
	                        <!-- <div>
