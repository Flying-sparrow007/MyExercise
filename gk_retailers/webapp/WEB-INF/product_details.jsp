...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" class="mImg" src="${basePath}${good.image}"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        ...
        <div class="shops">
            ...
            <a href="${basePath}/cart/showCart.do" class="shop lf" id="add_cart"><img src="../images/product_detail/product_detail_img7.png" alt=""/>加入购物车</a>
        ...
        <div class="all">
            ...
            <div id="sale_protection">
                ...
                <div class="sale_content">
                    ...
                    <p class="content">
                        益康特学子商城向您保证所售商品均为正品行货，益康特自营商品开具机打发票或电子发票。
                    </p>
                    ...
                    <p class="content">
                        凭质保证书及益康特商城发票，可享受全国联保服务，与您亲临商场选购的商品享受相同的质量保证。益康特商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！
            ...
            <div id="packing_list">
                ...
                <p class="content">笔记本 x1 适配器 x1 电源线 x1 电池 x1 说明书（电子版）x1 备注：笔记本电脑的背面只会标注此电脑的系列，例如： XPS 13-9360 ，
                    如果您需要核实此电脑的具体配置型号是否与益康特页面相符，可电话咨询益康特厂商：800-858-2969</p>
            </div>
        </div>
    </div>
    <div class="right rt">
